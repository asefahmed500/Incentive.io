...
- Name: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts >> Authentication - Login >> login form validation
- Location: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts:43:3
