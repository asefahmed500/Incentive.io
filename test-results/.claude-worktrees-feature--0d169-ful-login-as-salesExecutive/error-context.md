...
- Name: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts >> Authentication - Login >> successful login as salesExecutive
- Location: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts:18:5
