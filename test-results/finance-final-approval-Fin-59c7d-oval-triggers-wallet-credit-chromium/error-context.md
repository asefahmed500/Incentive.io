...
- Name: finance\final-approval.spec.ts >> Finance - Final Approval >> final approval triggers wallet credit
- Location: tests\e2e\specs\finance\final-approval.spec.ts:22:3
