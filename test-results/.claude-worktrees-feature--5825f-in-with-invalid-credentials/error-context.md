...
- Name: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts >> Authentication - Login >> failed login with invalid credentials
- Location: .claude\worktrees\feature-a\tests\e2e\specs\auth\login.spec.ts:30:3
