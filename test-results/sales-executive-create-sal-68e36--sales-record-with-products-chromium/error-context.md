...
- Name: sales-executive\create-sale.spec.ts >> Sales Executive - Create Sale >> create sales record with products
- Location: tests\e2e\specs\sales-executive\create-sale.spec.ts:23:3
