...
- Name: sales-executive\dashboard.spec.ts >> Sales Executive - Dashboard >> dashboard displays sales records table
- Location: tests\e2e\specs\sales-executive\dashboard.spec.ts:35:3
...
waiting for navigation until "load"
  navigated to "http://localhost:3000/login?email=karim%40incentive.io&password=Executive123%21"
============================================================
```
