...
- Name: sales-executive\create-sale.spec.ts >> Sales Executive - Create Sale >> form validation on empty fields
- Location: tests\e2e\specs\sales-executive\create-sale.spec.ts:80:3
