...
sleep 3
agent-browser screenshot --output tests/screenshots/fin-dashboard-initial.png

# Verify dashboard loaded
echo "Verifying dashboard elements..."
agent-browser eval 'window.location.pathname'
agent-browser screenshot --output tests/screenshots/fin-dashboard-full.png
...
# Check for charts
agent-browser screenshot --output tests/screenshots/fin-dashboard-charts.png
agent-browser eval 'document.querySelectorAll("svg").length > 0 ? "Charts found" : "No charts"'
agent-browser close

echo "✓ Finance dashboard loaded successfully"
echo "======================================"
