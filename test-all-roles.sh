...
# Incentive.io - Comprehensive Role-Based Feature Testing
...
test_endpoint "Register New User" "$BASE_URL/api/register" "201" "POST" \
    '{"name":"Test Executive","email":"testexec_'$(date +%s)'@example.com","password":"TestPass123!","phone":""}'
echo ""
...
login_user "jamal@incentive.io" "Jamal123!"
test_auth_endpoint "Executive blocked from Admin" "$BASE_URL/admin" "302"  # Should redirect
test_auth_endpoint "Executive blocked from Manager" "$BASE_URL/sales-manager" "302"

# Sales Manager should be blocked from admin pages
login_user "manager@incentive.io" "Manager123!"
test_auth_endpoint "Manager blocked from Admin" "$BASE_URL/admin" "302"
test_auth_endpoint "Manager blocked from Accountant" "$BASE_URL/accountant" "302"

# Admin should be blocked from Administrator pages
login_user "admin@incentive.io" "Admin123!"
test_auth_endpoint "Admin blocked from Administrator" "$BASE_URL/administrator" "302"
